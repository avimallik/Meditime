package com.armavi.medi.time.data;
...
public final class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "jul.db";
    ...
    public static final String COL_MEDTYPE = "medType";
    ...
    public ArrayList<Alarm> getAlarms() {
        ...
        try{
            c = getReadableDatabase().query(TABLE_NAME, null, null, null, null, null, null, null);
