...
import com.armavi.medi.time.Notifier;
...
//        builder.setContentIntent(pIntent);
        ...
        Intent i = new Intent();
        i.setClassName(context.getPackageName(), Notifier.class.getName());
        i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        i.putExtra("med_label_key", alarm.getLabel());
        i.putExtra("med_type_key", alarm.getMedType());
        i.putExtra("med_schedule_key", alarm.getDescription());
