package com.armavi.medi.time.util;
...
import static com.armavi.medi.time.data.DatabaseHelper.COL_FRI;
import static com.armavi.medi.time.data.DatabaseHelper.COL_IS_ENABLED;
import static com.armavi.medi.time.data.DatabaseHelper.COL_LABEL;
import static com.armavi.medi.time.data.DatabaseHelper.COL_DESCRIPTION;
import static com.armavi.medi.time.data.DatabaseHelper.COL_MEDTYPE;
import static com.armavi.medi.time.data.DatabaseHelper.COL_MON;
import static com.armavi.medi.time.data.DatabaseHelper.COL_SAT;
import static com.armavi.medi.time.data.DatabaseHelper.COL_SUN;
import static com.armavi.medi.time.data.DatabaseHelper.COL_THURS;
import static com.armavi.medi.time.data.DatabaseHelper.COL_TIME;
import static com.armavi.medi.time.data.DatabaseHelper.COL_TUES;
import static com.armavi.medi.time.data.DatabaseHelper.COL_WED;
import static com.armavi.medi.time.data.DatabaseHelper._ID;
...
public final class AlarmUtils {
    ...
    public static ContentValues toContentValues(Alarm alarm) {
        ...
        cv.put(COL_MEDTYPE, alarm.getMedType());
    ...
    public static ArrayList<Alarm> buildAlarmList(Cursor c) {
        ...
        if (c.moveToFirst()){
            do {
                ...
                final String medType = c.getString(c.getColumnIndex(COL_MEDTYPE));
                //Take Medicine before and after
                //Code here
                ...
                final Alarm alarm = new Alarm(id, time, label, description, medType);
